...
namespace HospitalService.Controllers
{
    ...
    public class PatientController : BaseApiController
    {
        ...
        /// </summary>
        [HttpGet]
        [SwaggerOperation(Summary = "Returns list of all the patients in database.")]
        ...
        [SwaggerOperation(Summary = "Returns patient by id.")]
        ...
        [SwaggerOperation(Summary = "Deletes patient from database by Id.")]
        ...
        [HttpPost]
        [SwaggerOperation(Summary = "Adds new patient to database.")]
        ...
        [SwaggerOperation(Summary = "Modifies an existing patient in database.")]
